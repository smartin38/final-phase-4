            ...
            <Hero>
                <Hero.Content className="flex-col lg:flex-row">
                    <div className="text-center space-y-7">
                        ...
                        <a className="space-y-7 text-sky-400 after:content-['_↗'] ..." href="tel:1234567890">+1 (123) 456 7890</a><br></br>
                        <a className="space-y-7 text-sky-400 after:content-['_↗'] ..." href="mailto:realperson@autoeris.ml">realperson@gmail.com</a>
                        <p>
